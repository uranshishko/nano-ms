...
class /** @class */ NanoMS {
	...
	constructor(port, options = {}) {
		...
		//* Initializing server
		this.server = http.createServer(options, (req, res) => {
	 ...
	 * @param {{ path: string, method: string, middleware: {[key: string]: Function}, func: (req: Request, res: Response) => Response | void)}} service
	 */
